...
export function AiPlanningPanel({ accessToken, assignmentId, weekStart, currentFields, hasScheduledLessons, onApplyField }: AiPlanningPanelProps) {
  ...
  return (
    <section className="panel ai-planning-panel" aria-labelledby="ai-planning-heading">
      ...
      <div className="guidance-card" role="note"><strong>Professional planning only.</strong><p>Do not enter student names, identifiers, grades, identifiable student work, IEP/504, health, discipline, or other student-specific information.</p></div>

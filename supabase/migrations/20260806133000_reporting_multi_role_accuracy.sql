-- Keep aggregate school reporting aligned with the governed multi-role model.
-- The original view used profiles.role, a compatibility column that represents
-- only one selected role. profile_roles is the authoritative role source.
...
comment on view public.school_admin_usage_summary is
  'School-level teacher-planning adoption summary using active governed profile_roles.';
